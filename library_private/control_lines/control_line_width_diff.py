###############################################################################################
# File Name: control_line_width_diff.py
# Description: This file primarily contains the construction code for the ControlLineWidthDiff.
############################################################################################
...
class ControlLineWidthDiff(LibraryBase):
    """
    ControlLineWidthDiff class.
    ...
    default_options = Dict(
        ...
        pos=[(0, 0), (500, 0), (500, -1000), (1000, -1000), (1000, 0), (1000, 1000)],
        width=[15, 10],
        gap=[5, 4],
        buffer_length=100,
        corner_radius=20
    ...
    def __init__(self, options=Dict()):
        """
        Initializes the ControlLineWidthDiff class.
