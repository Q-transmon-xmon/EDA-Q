...
from PyQt5.QtWidgets import (QDialog, QFormLayout, QLineEdit, QPushButton, QVBoxLayout, QLabel, QHBoxLayout, QMessageBox ,
                             QWidget)
...
class ComponentActions(QObject):  
    ...
    def show_param_window(self, fields, component_type , image_path):  
        ...
        if component_type == "AirBridge" or component_type == "AirbriageNb" or component_type == "IndiumBump" :
            image_label = QLabel()
            pixmap = QPixmap(str(image_path))  # load picture
