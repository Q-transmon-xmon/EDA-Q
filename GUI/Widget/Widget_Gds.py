...
class Window_Gds(QtCore.QObject):
    ...
    def __init__(self, design, tree, content_layout):
        ...
        self.original_values = {}  # Store raw values and type information
    ...
    def display_dict(self, dict_data, item):
        ...
        for key, value in dict_data.items():
            ...
            # Store raw values and type information
        ...
        try:
            if original_info['is_numpy']:
                ...
                try:
                    ...
                    return original_info['value']  # Maintain the original value
    ...
    def on_text_changed(self, text):
        ...
        if new_value is not None:
            ...
            # Set red border when parsing fails
