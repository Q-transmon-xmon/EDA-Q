...
class DataFrameDisplay(QMainWindow):
    def __init__(self, file_path):
        ...
        main_layout.setSpacing(20)  # Set spacing between widgets
        ...
        main_layout.addWidget(self.metadata_label, 1)  # Stretch factor 1
        ...
        main_layout.addWidget(self.table_widget, 4)  # Stretch factor 4
