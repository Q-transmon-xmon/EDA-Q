...
from PyQt5.QtWidgets import (QDialog, QDialogButtonBox, QLabel, QLineEdit,
                             QHBoxLayout, QVBoxLayout, QWidget, QMessageBox, QPushButton)
...
class Dialog_pins(QDialog):
    ...
    def __init__(self, design, parent=None):
        ...
        self.setFont(QFont("Microsoft YaHei", int(10.5)))  # Convert to int
        self.resize(500, 400)
        self.design = design
        ...
        # Title label
        titleLabel = QLabel("Pin Generation")
        titleLabel.setFont(QFont("Arial", 14, QFont.Bold))
        titleLabel.setAlignment(Qt.AlignCenter)
        self.mainLayout.addWidget(titleLabel)

        # Instructions label
        instructionsLabel = QLabel("Please enter the pin details below:")
    ...
    def submitValues(self):
        ...
        for key, line_edit in self.lineEdits.items():
            ...
            try:
                ...
                pin_ops[key] = converted_value  # Save to updated dictionary
