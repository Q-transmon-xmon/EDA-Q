...
class Ui_Dialog_RResonator(object):
    def setupUi(self, Dialog_RResonator):
        if not Dialog_RResonator.objectName():
            Dialog_RResonator.setObjectName("Dialog_RResonator")
        Dialog_RResonator.resize(600, 500)
        # Set the font of the entire interface to Microsoft YaHei
        Dialog_RResonator.setFont(QFont("Microsoft YaHei", int(10.5)))
        self.verticalLayout = QVBoxLayout(Dialog_RResonator)
        ...
        self.rdlsLineEdit.setText("ReadoutResonator")  # Set default value
        ...
        self.chipLayerLabel = QLabel("Chip Name:")  # New label
        ...
        self.dictFrame = QFrame(Dialog_RResonator)
        ...
        self.buttonBox = QDialogButtonBox(Dialog_RResonator)
        ...
        self.retranslateUi(Dialog_RResonator)
        QMetaObject.connectSlotsByName(Dialog_RResonator)
    ...
    def retranslateUi(self, Dialog_RResonator):
        Dialog_RResonator.setWindowTitle(QCoreApplication.translate("Dialog_RResonator", "Generate Readout Resonator"))


class Dialog_RResonator(QtWidgets.QDialog, Ui_Dialog_RResonator):
    ...
    def __init__(self, design):
        ...
        self.buttonBox.accepted.connect(self.process_RResonator)
...
if __name__ == "__main__":
    ...
    dialog = Dialog_RResonator(design)
