############################################################################################
# File Name: Airbriage_Nb.py
# Description: This file defines the construction and drawing functionality for Nb (niobium) 
#              air bridges, generating GDS-format geometric shapes.
############################################################################################
...
class AirbriageNb(LibraryBase):
    ...
    def _add_polygons_to_cell(self):
        polygon_data = [
            ([[-18.0, -57.0], [18.0, -57.0], [18.0, -30.0], [10.0, -22.0], [10.0, 22.0], 
              [18.0, 30.0], [18.0, 57.0], [-18.0, 57.0], [-18.0, 30.0], [-10.0, 22.0], 
              [-10.0, -22.0], [-18.0, -30.0]], 3),

            ([[-22.0, 24.5], [-15.5, 18.0], [15.5, 18.0], [22.0, 24.5], [22.0, 61.0], 
              [-22.0, 61.0]], 2),

            ([[-22.0, -61.0], [22.0, -61.0], [22.0, -24.5], [15.5, -18.0], 
              [-15.5, -18.0], [-22.0, -24.5]], 2),
    ...
    def calc_general_ops(self):
        ...
        # Update gds_pos to match the adjusted center
