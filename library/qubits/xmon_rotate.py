...
class XmonRotate(LibraryBase):
    ...
    def draw_gds(self):
        ...
        import math
        qubit_polygon = gdspy.Polygon(qubit.get_points())
        qubit_polygon.rotate(math.radians(rotation), self.gds_pos)
        self.cell.add([qubit_polygon])
        ########################################################################
        return
